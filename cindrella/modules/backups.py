...
__help__ = """
*Yalnız qrup admini:*
  - /import: köçürməni çox sadə etməklə mümkün qədər çox idxal etmək üçün qrup uşağasının ehtiyat faylına cavab verin! Qeyd \
teleqram məhdudiyyətlərinə görə fayllar/şəkillər idxal edilə bilməz.
  - /export: ixrac ediləcək qrup datası bunlardır: qaydalar, qeydlər (sənədlər, şəkillər, musiqi, video, audio, səs, mətn, mətn düymələri)
  """
