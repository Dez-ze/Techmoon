...
def afk(bot: Bot, update: Update):
    ...
    update.effective_message.reply_text("{} AFK-dır!".format(fname))
        ...
        for ent in entities:
            ...
            if ent.type == MessageEntity.MENTION:
                ...
                try:
                    ...
                    print("Xata: {} AFK modulu üçün user tapılmadı".
                          format(user_id))
                    return
...
def check_afk(bot, update, user_id, fst_name, userc_id):
    ...
    if sql.is_afk(user_id):
        ...
        if not user.reason:
            ...
            if int(userc_id) == int(user_id):
                return
            res = "{} AFK-dır.\nSəbəb: {}".format(fst_name, user.reason)
            update.effective_message.reply_text(res)


__help__ = """
 - /afk <səbəb>: Özünü AFK et.
 - brb <səbəb>: AFK edilən hesab tag edildikdə, və ya reply ediləndə atılan mesaj
"""
